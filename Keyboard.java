...
public class Keyboard {
    ...
    public static void main(String... args) throws Exception {
        ...
        String[] wordlist = {"Sad chunk","HONGRY chonk","OG squish","Zoned out chunk","Blanket pt 4","Figured out the bed chunk","Falling out the bed chunk"};
        int listlen = wordlist.length;
        int n = 0;
        robot.delay(5000);
        while (n < 1000) {
            int wordloc = n % listlen;
            String word = wordlist[wordloc];
            keyboard.type(word);
